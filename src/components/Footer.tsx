      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <h3 className="text-xl font-bold text-white mb-2">Moultamiss Imane</h3>
            <p className="text-sm max-w-md">
              Full Stack Developer creating elegant, efficient, and user-friendly websites and applications.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="#home" className="text-sm hover:text-cyan-400 transition-colors">Home</a>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="text-sm">
                  ...
                  <a href="mailto:hello@moultamiss.dev" className="hover:text-cyan-400 transition-colors">
        ...
        <div className="mt-10 pt-6 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-xs mb-4 md:mb-0">
            &copy; {currentYear} Moultamiss Imane. All rights reserved.
          </p>
